...
<html lang="en">
  ...
  <head>
    ...
    <title>SD NEGERI 2 PURABAYA</title>
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="Beranda"><h2>SD NEGERI 2 PURABAYA</h2></a>
    ...
    <div class="sub-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p>Copyright &copy; 2023 Kelompok 1
          </div>
        </div>
      </div>
    </div>
